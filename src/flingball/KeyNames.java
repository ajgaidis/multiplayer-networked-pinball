...
/**
 * An immutable, threadsafe datatype containing key integer values and their
 * mappings to their string representations.
 */
public class KeyNames {

    /**
     * A mapping of the integer representations of keys to their String form
     */
    final static Map<Integer,String> keyName;
    static {
    ...
    /**
     * The main method that tests to ensure the mapping is working
     * 
     * @param args if the "Linux problem" occurs, the first and only argument should be
     *             [--magic].
     */
